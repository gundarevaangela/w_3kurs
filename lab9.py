...
def init_boxes():
    ...
    user_opened_gifts.query.delete()
    ...
    boxes = [
        ...
        gift_box(id=2, pos_top=80, pos_left=600, requires_auth=False,
        ...
        gift_box(id=8, pos_top=280, pos_left=2000, requires_auth=True,
                 message="🔥 ОСОБЫЙ ПОДАРОК: Успехов в учебе и карьерного роста! Только для авторизованных!"),
        gift_box(id=9, pos_top=480, pos_left=600, requires_auth=True,
                 message="❤️ ОСОБЫЙ ПОДАРОК: Любви, взаимопонимания и гармонии! Только для авторизованных!"),
        gift_box(id=10, pos_top=480, pos_left=1600, requires_auth=True,
