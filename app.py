...
if app.config['DB_TYPE'] == 'postgres':
    db_name = 'angela_gundareva_orm'
    db_user = 'angela_gundareva_orm'
    db_password = '123'
    host_ip = '127.0.0.1'
    host_port = '5432'
    ...
    db_path = path.join(dir_path, "angela_gundareva_orm.db")
...
<html>
    ...
    <body>
        ...
        <nav>
            ...
            <a href="/rgz">Расчетно-графическое задание</a><br>
